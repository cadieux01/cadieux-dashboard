      ...
      <div className="relative flex items-start justify-between gap-2">
        <div className="min-w-0">
          ...
          {trend !== undefined && (
            ...
            >
              <svg className={`h-3 w-3 ${trendUp ? '' : 'rotate-180'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {icon && (
          <div className={`flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg [&_svg]:h-4 [&_svg]:w-4 ${theme.icon}`}>
            {icon}
          </div>
        )}
      </div>
